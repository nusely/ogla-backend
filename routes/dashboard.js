...
router.get("/stats", authenticateToken, requireAdmin, async (req, res) => {
  ...
  try {
    ...
    const [userResults, productResults, requestResults, pendingRequestResults, revenueResults, reviewResults, storyResults] = await Promise.all([
      ...
      getEntityStats("stories", { whereClause: "isActive = 1" })
    ]);
    ...
    const [totalStories, storiesThisMonth, storiesLastMonth] = storyResults;
    ...
    const response = {
      ...
      data: {
        ...
        stories: {
          ...
          growthPercent: calculateGrowth(storiesThisMonth, storiesLastMonth),
        },
      },
      timing: { duration },
    };
